    ...
    return(
        <Grid container spacing={2}>
            ...
            <Grid container item xs={12} justify="center" alignItems="center"> 
                    <Button className={classes.button} variant="contained" size="medium" onClick={createTransaction}>Add</Button>
                    <PushToTalkButton size='2rem' intro="" gradientStops='green'/>
                    <ErrorPanel />
            </Grid>
        </Grid>
    )
